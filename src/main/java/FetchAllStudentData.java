...
/**
 * Servlet implementation class FetchAllStudentData
 */
@WebServlet("/views/admin/FetchAllStudentData")
public class FetchAllStudentData extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FetchAllStudentData() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      doPost(request, response); // Optional: make GET also work
...
//    
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (
        	...
        	String query = "SELECT DISTINCT si.*, ta.*, pa.*, ai.*, hi.*, sc.* " +
                    "FROM students si " +
            ...
            e.printStackTrace();
            request.setAttribute("error", "Error fetching student data.");
        }
