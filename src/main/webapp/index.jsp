            ...
            <div class="col-lg-6 col-md-8 mx-auto">
                <div class="login-box p-5 ">
                    ...
                    <form action="Login_Servlet"  method="post">
                        ...
                        <!-- Email Field -->
                        <div class="mb-3">
                            <label for="Login_username" class="form-label fw-bold focus-color">Email</label>
                            <input type="text" class="form-control" id="Login_username" name="Login_username" required placeholder="Enter your email">
                        </div>

                        <!-- Password Field -->
                        <div class="mb-5">
                            <label for="Login_password" class="form-label fw-bold focus-color">Password</label>
                            <input type="password" class="form-control" id="Login_password" name="Login_password" required placeholder="Enter your password">
                        </div>
