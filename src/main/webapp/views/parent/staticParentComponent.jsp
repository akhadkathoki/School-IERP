...
<body>
	<%
	    ...
	    if (sessions == null || sessions.getAttribute("parentId") == null) {
	    ...
	    int teacherId = Integer.parseInt(sessions.getAttribute("parentId").toString());
	%>
...
<div class="sideBar text-white pt-2" id="sidebar">
    <ul class="nav flex-column  overflow-auto">
        ...
        <li class="nav-item nav-item-option">
            <a href="children.jsp" class="nav-link text-white"><i class="bi bi-people"></i> Children</a>
        </li>
        <li class="nav-item nav-item-option">
            <a href="parentDashboard.jsp" class="nav-link text-white"><i class="bi bi-speedometer2"></i> Dashboard</a>
        </li>
        <li class="nav-item nav-item-option">
        ...
        <li class="nav-item nav-item-option">
            <a href="reachUs.jsp" class="nav-link text-white"><i class="bi bi-geo-alt-fill"></i> Reach Us</a>
        </li>
