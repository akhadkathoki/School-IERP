<%@ page import="java.util.List, com.IERP_FINAL.models.Admin" %>
...
<div class="sideBar text-white pt-2" id="sidebar">
    <ul class="nav flex-column  overflow-auto">
        ...
        <li class="nav-item nav-item-option">
            <a href="adminDashboard.jsp" class="nav-link text-white"><i class="bi bi-speedometer2"></i> Dashboard</a>
        </li>
        <li class="nav-item nav-item-option">
            <a href="AdminSpecificProfile" class="nav-link text-white"><i class="bi bi-person"></i> Profile</a>
        </li>


        <li class="nav-item nav-item-option">
            <form action="FetchAllStudentData" method="post" style="display:inline;">
			    <button type="submit" class="btn text-start w-100 nav-link text-white" >
			        <i class="bi bi-calendar-check"></i> Students
			    </button>
			</form>
        ...
        <li class="nav-item nav-item-option">
	        <form action="TeacherServlet" method="post" enctype="multipart/form-data" style="display:inline;">
				    ...
				    <button type="submit" class="btn text-start w-100 nav-link text-white" >
				        <i class="bi bi-calendar-check"></i> Teachers
				    </button>
			</form>
        </li>
        <li class="nav-item nav-item-option">
            <a href="RegisterParentInfo" class="nav-link text-white"><i class="bi bi-calendar-check"></i> Parents</a>
        </li>
        <li class="nav-item nav-item-option">
            <a href="FetchAdminData" class="nav-link text-white"><i class="bi bi-calendar-check"></i>  Admins</a>
        </li>
        ...
        <li class="nav-item nav-item-option">
		    <a href="HolidayServlet" class="w-100 nav-link text-white" >
		        <i class="bi bi-calendar-check"></i> Holidays
		    </a>
        </li>
        
        <li class="nav-item nav-item-option">
            <form action="AnnouncementServlet" method="get" enctype="multipart/form-data" style="display:inline;">
	       			<input type="hidden" name="action" value='list'>
				    <button type="submit" class="btn text-start w-100 nav-link text-white" >
        ...
        <li class="nav-item nav-item-option">
	        <form action="AdminLogoutServlet" method="get">
			    <button type="submit" class="nav-link text-white"><i class="bi bi-box-arrow-right"></i> Logout</button>
			</form>
        </li>
    </ul>
</div>
