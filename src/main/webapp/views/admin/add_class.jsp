...
<div class="container main p-3 d-flex flex-column justify-content-center align-items-start">
    ...
    <div class="container main mt-4 p-3 shadow-sm rounded bg-white bg-opacity-75 d-flex flex-column justify-content-center align-items-start">
        <h1 class="heading-font text-right fs-4">Add Class</h1>
        ...
        <div class="row w-100 d-flex flex-row justify-content-start">  
			...
			<form class="row g-3" action="AddClassServlet" method="post">
                ...
                <div class="form-group col-md-6 col-lg-4 mb-3">
                    ...
                    <input type="number" class="form-control shadow-sm rounded" id="classLevel" name="classLevel" placeholder="e.g., Level 1" required>
                </div>

                <!-- Section -->
                <div class="form-group col-md-6 col-lg-4 mb-3">
                    <label for="section" class="topic-font fw-bold">Section:</label>
                    <input type="text" class="form-control shadow-sm rounded" id="section" name="section" placeholder="e.g., A" required>
                </div>

                <!-- Class Teacher ID -->
                <div class="form-group col-md-6 col-lg-4 mb-3">
                    <label for="class_teacher_id" class="topic-font fw-bold">Class Teacher ID:</label>
                    <input type="number" class="form-control shadow-sm rounded" id="class_teacher_id" name="classTeacherId" placeholder="e.g., 101" required>
                </div>

                <!-- Submit Button -->
                <div class="d-flex flex-row justify-content-end">
                    <button type="submit" class="btn text-white px-3" style="background-color: #292648;">Add Classroom</button>
                </div>
            </form>
        </div> 
