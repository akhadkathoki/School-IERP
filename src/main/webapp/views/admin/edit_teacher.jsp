...
<body style="background-color: #CDD5DB;">
    ...
    <% if (teacher != null) { %>
        <div class="container py-5">
            ...
            <h1 class="heading-font text-right fs-2">Edit <%= teacher.getFullName() %>'s Profile</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
          	       <form action="TeacherServlet" method="post" class="bg-transparent" enctype="multipart/form-data">
    		            ...
    		            <hr class="border-dark border-2 mb-3">
	                        ...
	                        <div class="row g-3"  >
	                            ...
	                            <div class="col-md-6 mb-3">
	                                ...
	                                <input type="text" id="student_id" name="student_id" class="form-control rounded" value="<%= teacher.getTeacherId() %>" disabled>
	                            </div>
	                           ...
	                           <input type="hidden" name="form" value="personalInfo">
								...
								<div class="col-md-6 mb-3">
								    ...
								    <input type="text" name="fullName" class="form-control rounded subName" value="<%= teacher.getFullName() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Date of Birth:</label>
								    <input type="date" name="dateOfBirth" class="form-control rounded subName" value="<%= teacher.getDateOfBirth() != null ? teacher.getDateOfBirth().toString() : "" %>" required>
								</div>
								...
								<div class="col-md-6 mb-3">
								    ...
								    <input type="text" name="nationality" class="form-control rounded subName" value="<%= teacher.getNationality() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Citizenship Number:</label>
								    <input type="text" name="citizenshipNumber" class="form-control rounded subName" value="<%= teacher.getCitizenshipNumber() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Citizenship Issue Place:</label>
								    <input type="text" name="citizenshipIssuePlace" class="form-control rounded subName" value="<%= teacher.getCitizenshipIssuePlace() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Citizenship Issue Date:</label>
								    <input type="date" name="citizenshipIssueDate" class="form-control rounded subName" value="<%= teacher.getCitizenshipIssueDate() != null ? teacher.getCitizenshipIssueDate().toString() : "" %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Contact Number:</label>
								    <input type="text" name="contactNumber" class="form-control rounded subName" value="<%= teacher.getContactNumber() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Email Address:</label>
								    <input type="email" name="emailAddress" class="form-control rounded subName" value="<%= teacher.getEmailAddress() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Permanent Address:</label>
								    <textarea name="permanentAddress" class="form-control rounded subName" rows="2" required><%= teacher.getPermanentAddress() %></textarea>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Temporary Address:</label>
								    <textarea name="temporaryAddress" class="form-control rounded subName" rows="2"><%= teacher.getTemporaryAddress() %></textarea>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Username:</label>
								    <input type="text" name="username" class="form-control subName rounded" value="<%= teacher.getUsername() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Password:</label>
								    <input type="password" name="password" class="form-control subName rounded" value="<%= teacher.getPassword() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Photo:</label>
								    <input type="file" name="photo" class="form-control subName rounded" accept="image/*">
								    <% if (teacher.getPhoto() != null) { %>
	                    ...
	                    <!-- Teacher Qualification-->
		                    <div class="profile-card p-4 mb-3">
								...
								<div class="col-md-6 mb-3">
								    ...
								    <input type="text" name="highestQualification" class="form-control rounded subName"
								           placeholder="e.g., M.Ed, B.Ed, PhD"
								           value="<%= teacher.getHighestQualification() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Specialization:</label>
								    <input type="text" name="specialization" class="form-control rounded subName"
								           placeholder="e.g., Mathematics, English, Science"
								           value="<%= teacher.getSpecialization() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Qualification Score (%):</label>
								    <input type="number" name="qualificationScore" step="0.01" class="form-control rounded subName"
								           placeholder="e.g., 85.50"
								           value="<%= teacher.getQualificationScore() %>" required>
								</div>
								
								<div class="col-md-6 mb-3">
								    <label class="name">Upload Certification Image:</label>
								    <input type="file" name="certificationImage" class="form-control rounded subName" accept="image/*,application/pdf">
							...
							<div class="profile-card p-4 mb-3">
							    ...
							    <div class="row g-3">
								    ...
								    <div class="col-md-6 mb-3">
								        ...
								        <input type="text" name="teachingLicenseNumber" class="form-control rounded subName"
								               placeholder="Enter license number"
								               value="<%= teacher.getTeachingLicenseNumber() %>">
								    </div>
								
								    <!-- License Issue Date -->
								    <div class="col-md-6 mb-3">
								        <label class="name">License Issue Date:</label>
								        <input type="date" name="licenseIssueDate" class="form-control rounded subName"
								               value="<%= teacher.getLicenseIssueDate() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(teacher.getLicenseIssueDate()) : "" %>">
								    </div>
								
								    <!-- License Expiry Date -->
								    <div class="col-md-6 mb-3">
								        <label class="name">License Expiry Date:</label>
								        <input type="date" name="licenseExpiryDate" class="form-control rounded subName"
								               value="<%= teacher.getLicenseExpiryDate() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(teacher.getLicenseExpiryDate()) : "" %>">
								    </div>
								
								    <!-- License Image Upload -->
								    <div class="col-md-6 mb-3">
								        <label class="name">Upload License Image:</label>
								        <input type="file" name="licenseImage" class="form-control rounded subName">
							    ...
							    <div class="row g-3">
									...
									<div class="col-md-6 mb-3">
									    ...
									    <input type="text" name="emergencyContactName" class="form-control rounded subName"
									           ...
									           value="<%= teacher.getEmergencyContactName() %>">
									</div>
									...
									<div class="col-md-6 mb-3">
									    ...
									    <input type="text" name="emergencyContactNumber" class="form-control rounded subName"
									           ...
									           value="<%= teacher.getEmergencyContactNumber() %>">
									</div>
									...
									<div class="col-md-6 mb-3">
									    ...
									    <input type="email" name="emergencyEmail" class="form-control rounded subName"
									           ...
									           value="<%= teacher.getEmergencyEmail() %>">
									</div>
									...
									<div class="col-md-6 mb-3">
									    ...
									    <input type="text" name="relationshipWithEmergencyContact" class="form-control rounded subName"
									           ...
									           value="<%= teacher.getRelationshipWithEmergencyContact() %>">
									</div>
							...
							<div class="col-12 d-flex flex-row justify-content-end">
							    <button class="btn px-5 text-white mt-3" style="background-color: #292648;">Save</button>
							</div>
