...
<div class="container main  mt-4 p-3 bg-transparent d-flex flex-column justify-content-center align-items-start">
	<div class="d-flex flex-row justify-content-between w-100">
		...
		<a href="add_holidays.jsp" class="pt-2  btn px-lg-5 px-3 text-white" type="button" style="background-color: #292648;" >
		        	Add
	      </a>
	</div>
				...
				<div class="p-3 pl-4 shadow-sm mb-3 rounded bg-white d-flex flex-column justify-content-center align-items-start" > 
					...
					<div class="w-100 table-responsive">
						 <table class="table table-bordered table-hover">
							...
							%>
								<tr class="text-center" onclick="window.location.href='HolidayServlet?id=<%= 
								    (holidayrow != null) 
								        ? holidayrow.getId() 
							        ...
							        <td style="background-color:#EBF4FF;" class="">
							            <a href="add_holidays.jsp?id=<%= holidayrow.getId() %>&action=edit" 
							               class="btn btn-sm text-white  " 
							               style="background-color: #292648;">
							               <i class="bi bi-pencil-square me-1"></i>
							            </a>
							            <a href="HolidayServlet?id=<%= holidayrow.getId() %>&action=delete" 
							               class="btn btn-sm text-white " 
							               style="background-color: #292648;"
