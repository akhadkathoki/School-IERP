...
<div class="container main  mt-4 p-3 shadow-sm rounded bg-white d-flex flex-column justify-content-center align-items-start">
	...
	<div class="row w-100">	
		<div class="col-12 col-sm-4 col-lg-3 pl-2 mb-3 text-white  rounded ">
			<div class="bg-primary bg-opacity-75 p-4 rounded shadow-sm border-none d-flex flex-row justify-content-around align-items-center" > 
				...
				<div class="vr border border-light border-2 "></div>
				<div class="d-flex flex-column justify-content-center  align-items-center text-center">
					<h1>10</h1>
				</div>
			</div>	
	...
	<div class="row p-0" >
		<div class="col-12 col-md-6  p-3">
			<div class="  shadow-sm p-2 rounded bg-white w-100 h-100">
				<h1 class="heading-font  text-right">My Details</h1>
	  				...
	  				<div class="col-12 col-lg-4   d-flex flex-column justify-content-start align-items-center">  	
	  					<div class="w-100 p-3 d-flex flex-column justify-content-start align-items-center">
		  					...
		  					<div class="d-flex flex-row  w-100 justify-content-around">
			  					<button class="btn px-lg-3 px-5 text-white" style="background-color: #292648;">Edit</button>
			  					<button class="btn px-lg-3 px-5 text-white" style="background-color: #292648;">Print</button>
							</div>
						</div>
	  				</div>
