...
<%
    ...
    if (studentIdObj == null) {
        response.sendRedirect("../../index.jsp"); // or show an error message
        return;
    }
...
<div class="sideBar text-white pt-2" id="sidebar">
    <ul class="nav flex-column  overflow-auto">
        ...
        <li class="nav-item nav-item-option">
        	<form action="StudentProfileDetails" method="get">
        		<input type="hidden" id="id" name="id" value="<%= studentId %>" >
        		<button type="submit" class="nav-link text-white"><i class="bi bi-person"></i> Profile</button>
        	</form>
        </li>
        ...
        <li class="nav-item nav-item-option">
            <a href="select_attendance.jsp" class="nav-link text-white"><i class="bi bi-calendar-check"></i> Attendance</a>
        </li>
        ...
        <li class="nav-item nav-item-option">
            <a href="LeaveApplication?id=<%= studentId %>&action=list" class="nav-link text-white"><i class="bi bi-file-earmark-text"></i> Leave Application</a>
        </li>
        <li class="nav-item nav-item-option">
            <a href="holidays_list.jsp" class="nav-link text-white"><i class="bi bi-calendar-event"></i> Holidays</a>
        </li>
        <li class="nav-item nav-item-option">
            <a href="AchievementServlet?action=list&id=<%= studentId %>" class="nav-link text-white"><i class="bi bi-trophy"></i> Achievements</a>
        </li>
