...
<div class="container main  mt-4 p-3 shadow-sm rounded bg-white bg-opacity-75 d-flex flex-column justify-content-center align-items-start">
		<h1 class="heading-font  text-right fs-4">Give Us Your Valuable Feedbacks</h1>
	...
	<form class="">
	    <div class="row mb-3">
	        <div class="form-group col-md-6">
	            <label for="feedbackType" class="topic-font fw-bold">Feedback For:</label>
	            <select class="form-control shadow-sm rounded" id="feedbackType" name="feedbackType">
	        ...
	        <div class="form-group col-md-6">
	            ...
	            <input type="text" class="form-control shadow-sm rounded" id="subject" name="subject" placeholder="Subject">
	        </div>
	    </div>
		...
		<div class="d-flex flex-row justify-content-end">
	    	<button type="submit" class="btn text-white px-3" style="background-color: #292648;">Submit Feedback</button>
	    </div>
	</form>
